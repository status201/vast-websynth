...
- **The Spectrum now tells you *which* frequency you are looking at.** It reads on
  ...
  **10k** Hz. **Hover the graph** with a mouse for the exact frequency under the
  pointer, and press **Zones** (a new button that appears in Spectrum view) to
  shade and name the four bands that usually need fixing: **MUD** 100–200 Hz,
  **BOXY** 300–500, **NASAL** 800 Hz–1 kHz and **HARSH** 4–6 kHz. Previously the
...
- **Two demos for the new micro-timing and time signatures features — Gankogui and
  ...
  the motion lane every 18 — so the whole thing only lands together once every six
  bars. Four drum lanes are switched to the percussion voices, and the closed hat
  runs in twos across the triple grouping.
