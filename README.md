...
- **Song chains**: build an arrangement (e.g. `A A B A C A A D`) per machine — independent seq, drum, sampler, and motion lanes, with an optional **rest** slot for an empty bar (a lane sits out without spending a bank)
