...
src/utils/music.ts:                                   # pure
  diatonicChord(anchorNote, root, scale, size): number[]   # size 2..4 tones, ascending
...
#   sus4  -> [0, 3, 4]      power -> [0, 4, 7 degrees=octave]
```
...
- **REQ-8 blocks a plain major triad in chromatic**, since there are no degrees without
